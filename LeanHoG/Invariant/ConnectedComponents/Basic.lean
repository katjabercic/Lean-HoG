...
class ConnectedComponents (G : Graph) : Type where
...
class ConnectedComponentsCertificate (G : Graph) : Type where
...
def ConnectedComponentsCertificate.componentEdge' {G : Graph} [C : ConnectedComponentsCertificate G] :
  ...
  unfold Batteries.RBSet.all at compEdge
